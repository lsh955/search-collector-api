...
exports.get = async (value) => {
	...
	const data = await htmlParsing(`https://openapi.naver.com/v1/search/webkr?query=${encodeURI(PARAMS.query)}&start=${PARAMS.start}&display=${PARAMS.display}&sort=${PARAMS.sort}`);
